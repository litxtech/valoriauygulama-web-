...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/notifications/sounds', icon: 'volume-high-outline', label: 'Bildirim sesleri' },
      { href: '/admin/notifications/event-log', icon: 'analytics-outline', label: 'Bildirim log & takip' },
  ...
  },
  {
    ...
    icon: 'albums-outline',
    items: [
      { href: '/admin/approvals', icon: 'shield-checkmark-outline', label: 'Onay merkezi', badge: 0 },
      ...
      { href: '/admin/payments', icon: 'card-outline', label: 'Ödemeler (Stripe / QR)' },
      ...
      { href: '/admin/room-service', icon: 'bed-outline', label: 'Oda servisi' },
      { href: '/admin/guest-extras', icon: 'pricetags-outline', label: 'Ekstra ücretler (battaniye, su…)' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/contracts', icon: 'document-outline', label: 'Misafir sözleşmeleri' },
      { href: '/admin/managed-contracts', icon: 'briefcase-outline', label: 'Sözleşme Yönetimi' },
      ...
      { href: '/admin/contracts/all', icon: 'document-text-outline', label: 'Misafir sözleşme onayları' },

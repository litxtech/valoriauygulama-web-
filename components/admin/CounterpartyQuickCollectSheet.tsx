...
const COLLECT_GRAD = ['#16a34a', '#15803d'] as const;
...
export function CounterpartyQuickCollectSheet({
  visible,
  person,
  defaultLedgerScope,
  staffId,
  ...
  useEffect(() => {
    ...
    reset();
    void loadMovementCategories(person.organization_id, 'income').then((opts) => {
      setCategoryOptions(opts);
      setCategory(opts[0]?.code ?? 'other');
    });
    setLoadingAgreements(true);
    void fetchOpenCounterpartyAgreements(person.id, 'income')
      .then((plans) => {
        ...
        >
          <View style={[styles.sheet, { paddingBottom: Math.max(insets.bottom, 16) }]}>
            ...
            <View style={styles.headRow}>
              <Text style={styles.headTitle}>Tahsilat al</Text>
            ...
            <View style={styles.personRow}>
              ...
              <View style={styles.personBody}>
                ...
                <Text style={styles.personSub}>Bu kişiden para alıyorsunuz</Text>
              </View>
            </View>
            ...
            >
              ...
              <View style={styles.block}>
                ...
                <TextInput
                  ...
                  placeholder="Örn. Günü birlik oda ücreti"
              ...
              <TouchableOpacity onPress={() => void save()} disabled={saving} activeOpacity={0.9} style={styles.saveWrap}>
                <LinearGradient colors={[...COLLECT_GRAD]} style={styles.saveBtn}>
                  {saving ? (
                    <ActivityIndicator color="#fff" />
                  ) : (
                    <>
                      <Ionicons name="checkmark-circle" size={20} color="#fff" />
                      <Text style={styles.saveBtnText}>Tahsilatı kaydet</Text>
                    </>
                  )}
                </LinearGradient>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  personSub: { fontSize: 12, color: '#15803d', marginTop: 2 },
  amountBox: {
  ...
  currency: { fontSize: 22, fontWeight: '800', color: '#16a34a', marginRight: 4 },
  ...
  quickChipText: { fontSize: 12, fontWeight: '700', color: '#15803d' },
  ...
  planOptOn: { borderColor: '#86efac', backgroundColor: '#f0fdf4' },
  ...
  segOn: { backgroundColor: '#16a34a', borderColor: '#16a34a' },

...
const styles = StyleSheet.create({
  ...
  premiumImageWrap: { width: '100%', aspectRatio: 1, position: 'relative', backgroundColor: menuUi.imagePlaceholder },
  ...
  premiumBody: { padding: 16, gap: 8, flex: 1 },
  premiumName: { fontSize: 16, fontWeight: '800', lineHeight: 21, letterSpacing: -0.2 },

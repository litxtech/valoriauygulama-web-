...
export function TradePartnerAdminGate({ children }: { children: ReactNode }) {
  ...
  if (!allowed) {
    return (
      <View style={styles.denied}>
        ...
        <Text style={styles.deniedTitle}>Partner Ticaret</Text>
...
const styles = StyleSheet.create({
  ...
  deniedLink: { marginTop: 8, fontSize: 15, fontWeight: '700', color: '#38bdf8' },
});

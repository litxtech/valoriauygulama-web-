...
export const NOTIFICATION_SOUND_FEATURES: NotificationSoundFeatureDef[] = [
  ...
  },
  {
    ...
    defaultIosPushSound: 'task_ping.wav',
    defaultAndroidPushSound: 'task_ping.wav',
  ...
  },
  {
    ...
    defaultIosPushSound: 'message_pop.wav',
    defaultAndroidPushSound: 'message_pop.wav',
  ...
  },
  {
    ...
    defaultIosPushSound: 'meal_chime.wav',
    defaultAndroidPushSound: 'meal_chime.wav',
  ...
  },
  {
    ...
    defaultIosPushSound: 'kbs_scan.wav',
    defaultAndroidPushSound: 'kbs_scan.wav',
  ...
  },
  {
    ...
    defaultIosPushSound: 'warning_alert.wav',
    defaultAndroidPushSound: 'warning_alert.wav',
  ...
  },
  {
    ...
    defaultIosPushSound: 'salary_cash.wav',
    defaultAndroidPushSound: 'salary_cash.wav',
  ...
  {
    featureKey: 'staff_departure',
    titleTr: 'Personel ayrılış',
    descriptionTr: 'Planlanan otelden çıkış tarihi oluşturma ve güncelleme bildirimleri.',
    audiences: ['staff', 'admin'],
    notificationTypeHints: [
    ...
    defaultIosPushSound: 'staff_departure_farewell.wav',
    defaultAndroidPushSound: 'staff_departure_farewell.wav',
    defaultAndroidChannelId: 'valoria_ns_staff_departure_v1',
    priority: 'high',
    userCanMuteSound: false,
    maxDurationSec: 4,
  },

...
export const STAFF_APP_PERMISSION_CATALOG: StaffAppPermissionEntry[] = [
  ...
  { key: 'housekeeping_yonetim', label: 'Housekeeping / canlı temizlik tahtası', section: 'guests_rooms', defaultEnabled: false },
  { key: 'yarin_oda_temizlik_listesi', label: 'Temizlik (eski plan yönlendirme)', section: 'guests_rooms', defaultEnabled: false },

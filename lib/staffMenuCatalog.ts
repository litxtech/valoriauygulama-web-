...
export const STAFF_MENU_CATALOG: StaffMenuCatalogEntry[] = [
  ...
  { id: 'ptt', labelTr: 'Bas-konuş (telsiz)', section: 'nav' },
  // Personel İşleri
  ...
  { id: 'passport_explore', labelTr: 'Pasaport Keşfeti', section: 'hotel' },
  // F&B ek
  ...
  { id: 'security_recordings', labelTr: 'Önemli kamera kayıtları', section: 'hotel' },
  { id: 'security_recordings_new', labelTr: 'Kamera kaydı yükle', section: 'hotel' },
  ...
  { id: 'checkout_board', labelTr: 'Çıkış Odaları', section: 'hotel' },
  ...
  { id: 'fault_records_new', labelTr: 'Arıza kaydı ekle', section: 'ops' },
  { id: 'fault_records', labelTr: 'Arıza kayıtları', section: 'ops' },
  ...
  { id: 'pos_receipt_invoice', labelTr: 'POS fiş yükle → fatura', section: 'ops' },
  { id: 'pos_receipt_list', labelTr: 'POS fiş / fatura listesi', section: 'ops' },
  { id: 'accounting', labelTr: 'Muhasebe merkezi', section: 'ops' },
  // Yönetim
  { id: 'admin_tab', labelTr: 'Yönetim sekmesi', section: 'admin' },
  { id: 'online_booking', labelTr: 'Online rezervasyon', section: 'admin' },
  { id: 'attendance_admin', labelTr: 'Mesai takibi (yönetim)', section: 'admin' },
  { id: 'staff_perf', labelTr: 'Personel Denetim Defteri', section: 'staff' },
  { id: 'staff_perf_admin', labelTr: 'Denetim yönetimi (İK)', section: 'admin' },
  { id: 'audits', labelTr: 'Eski bölüm denetim panosu', section: 'admin' },
  ...
  { id: 'notifications_hub', labelTr: 'Bildirim merkezi', section: 'admin' },
  { id: 'notifications_compose', labelTr: 'Bireysel bildirim gönder', section: 'admin' },
  { id: 'notifications_templates', labelTr: 'Otomatik push', section: 'admin' },
  { id: 'notifications_routing', labelTr: 'Kim hangi bildirimi alsın', section: 'admin' },

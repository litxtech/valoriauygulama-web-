...
export const APP_FEATURE_CATALOG: AppFeatureCatalogEntry[] = [
  ...
  { id: 'payments', labelTr: 'Ödeme al (QR)', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'payments' },
  {
    id: 'payments_admin',
    labelTr: 'Stripe ödemeler (liste)',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'payments_admin',
  },

...
export const APP_FEATURE_CATALOG: AppFeatureCatalogEntry[] = [
  ...
  { id: 'department_rules_admin', labelTr: 'Bölüm kuralları yönetimi', audience: 'admin', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'department_rules_admin' },

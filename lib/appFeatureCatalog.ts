...
export const APP_FEATURE_CATALOG: AppFeatureCatalogEntry[] = [
  ...
  { id: 'board', labelTr: 'Duyuru panosu', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'board' },
  {
    ...
    labelTr: 'Duyuru oluştur',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'announcement_compose',
  },
  {
    id: 'notifications_hub',
    labelTr: 'Bildirim merkezi',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'notifications_hub',
  },
  {
    id: 'notifications_compose',
    labelTr: 'Bireysel bildirim gönder',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'notifications_compose',
  },
  {
    id: 'notifications_templates',
    labelTr: 'Otomatik push',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'notifications_templates',
  },
  {
    id: 'notifications_routing',
    labelTr: 'Kim hangi bildirimi alsın',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'notifications_routing',
  },
  {
    id: 'engagement_tracking',
    labelTr: 'Okuma takibi',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'engagement_tracking',
  },
  ...
  { id: 'cleaning', labelTr: 'Temizlik', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'cleaning' },
  {
    ...
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'security_recordings',
  },
  {
    id: 'security_recordings_new',
    labelTr: 'Kamera kaydı yükle',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'security_recordings_new',
  },
  ...
  {
    id: 'expenses_new',
    labelTr: 'Yeni harcama girişi',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'expenses_new',
  },
  ...
  { id: 'fnb_hub', labelTr: 'F&B Merkezi', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fnb_hub' },
  { id: 'fnb_sales_new', labelTr: 'Anlık satış gir', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fnb_sales_new' },
  { id: 'fnb_kitchen_revenue', labelTr: 'Mutfak hasılat gir', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fnb_kitchen_revenue' },
  { id: 'fnb_menu_manage', labelTr: 'Menü yönet (F&B)', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fnb_menu_manage' },
  { id: 'fnb_menu_theme', labelTr: 'Web menü tasarımı', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fnb_menu_theme' },
  { id: 'guests', labelTr: 'Misafirler', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'guests' },
  { id: 'guest_complaints', labelTr: 'Misafir şikayetleri', audience: 'staff', defaultEnabled: false, defaultPlacements: ['hamburger'], hamburgerMenuId: 'guest_complaints' },
  { id: 'guest_service_requests', labelTr: 'Misafir talepleri', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'guest_service_requests' },
  { id: 'occupancy_ops', labelTr: 'Konaklama operasyon', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'occupancy_ops' },
  { id: 'checkout_board', labelTr: 'Çıkış Odaları', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'checkout_board' },
  { id: 'payment_board', labelTr: 'Oda Ödemeleri', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'payment_board' },
  { id: 'payments', labelTr: 'Tahsilat & QR ödemeler', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'payments_hub' },
  {
    id: 'payments_admin',
    labelTr: 'Tahsilat yönetimi (admin)',
    audience: 'staff',
    defaultEnabled: false,
    defaultPlacements: [],
    hamburgerMenuId: 'payments_hub',
  },
  { id: 'customer_service_requests', labelTr: 'Otel taleplerim', audience: 'customer', defaultEnabled: true, defaultPlacements: ['profile'] },
  { id: 'customer_hotel_info', labelTr: 'Otel bilgileri', audience: 'customer', defaultEnabled: true, defaultPlacements: ['profile'] },
  { id: 'customer_guest_extras', labelTr: 'Ekstra hizmetler (battaniye, su…)', audience: 'customer', defaultEnabled: true, defaultPlacements: ['profile'] },
  ...
  { id: 'facility_journal_new', labelTr: 'Otel eşyaları — yeni kullanım kaydı', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'facility_journal_new' },
  { id: 'facility_journal', labelTr: 'Otel eşyaları kullanım kayıtları', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'facility_journal' },
  { id: 'department_rules', labelTr: 'Bölüm kuralları', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'department_rules_staff' },
  { id: 'department_rules_admin', labelTr: 'Bölüm kuralları yönetimi', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'department_rules_admin' },
  { id: 'fault_records_new', labelTr: 'Arıza kaydı ekle', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fault_records_new' },
  { id: 'fault_records', labelTr: 'Arıza kayıtları', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'fault_records' },
  { id: 'lost_found_new', labelTr: 'Buluntu — yeni kayıt', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'lost_found_new' },
  { id: 'lost_found', labelTr: 'Buluntu — tüm kayıtlar', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'lost_found' },
  ...
  { id: 'kitchen_ops', labelTr: 'Mutfak operasyon (stok, hasılat, gün sonu)', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'kitchen_ops' },
  { id: 'kitchen_ops_manage', labelTr: 'Mutfak operasyon yönetimi (admin)', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'kitchen_ops_manage' },
  { id: 'kitchen_reception', labelTr: 'Mutfak muhasebe kontrol (reception)', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'kitchen_reception' },
  ...
  { id: 'debts', labelTr: 'Borç / alacak', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'debts' },
  {
    ...
    labelTr: 'Kişi ödemeleri (hızlı)',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'person_payments_quick',
  },
  {
    id: 'salary_quick',
    labelTr: 'Personel maaş girişi',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'salary_quick',
  },
  {
    id: 'salary_hub',
    labelTr: 'Maaş yönetimi',
    audience: 'staff',
    defaultEnabled: true,
    defaultPlacements: ['hamburger'],
    hamburgerMenuId: 'salary_hub',
  },
  {
    id: 'pos_receipt_invoice',
    labelTr: 'POS fiş yükle → fatura',
    audience: 'staff',
    defaultEnabled: false,
    defaultPlacements: [],
    hamburgerMenuId: 'pos_receipt_invoice',
  },
  {
    id: 'pos_receipt_list',
    labelTr: 'POS fiş / fatura listesi',
    audience: 'staff',
    defaultEnabled: false,
    defaultPlacements: [],
    hamburgerMenuId: 'pos_receipt_list',
  },
  ...
  { id: 'online_booking', labelTr: 'Online rezervasyon (hamburger)', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'online_booking' },
  ...
  { id: 'staff_perf', labelTr: 'Personel Denetim Defteri', audience: 'staff', defaultEnabled: true, defaultPlacements: ['hamburger'], hamburgerMenuId: 'staff_perf' },
  { id: 'audits', labelTr: 'Eski bölüm denetim panosu', audience: 'staff', defaultEnabled: false, defaultPlacements: [], hamburgerMenuId: 'audits' },
  { id: 'staff_month_best', labelTr: 'Ayın en iyi personeli', audience: 'staff', defaultEnabled: false, defaultPlacements: [], hamburgerMenuId: 'staff_month_best' },
  { id: 'transfer_a', labelTr: 'Transfer & tur (yönetim)', audience: 'staff', defaultEnabled: false, defaultPlacements: [], hamburgerMenuId: 'transfer_a' },
  { id: 'dining_a', labelTr: 'Yemek & mekanlar (yönetim)', audience: 'staff', defaultEnabled: false, defaultPlacements: [], hamburgerMenuId: 'dining_a' },
  ...
  { id: 'customer_profile_carbon', labelTr: 'Karbon ayak izi', audience: 'customer', defaultEnabled: false, defaultPlacements: [] },

...
const PLAN_CSS = `
  ...
  .planBox { flex: 1; min-width: 120px; background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 10px 12px; }
...
<div class="planHero">
  ...
  <div class="planGrid">
    ...
    <div class="planBox"><div class="planLbl">Kalan</div><div class="planVal planValRem">${esc(fmtMoneyTry(a.amount_remaining))}</div></div>
  </div>
...
<div class="section">
  ...
  ${
    input.movements.length === 0
      ...
      : `<table>
    <tr><th>Tarih</th><th>Tutar</th><th>Kategori</th><th>Ödeme</th><th>Açıklama</th></tr>
    ${paymentRows}
  </table>`
  }
</div>

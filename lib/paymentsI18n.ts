...
const TR = {
  ...
  paymentsQrModeStandingHint: 'Manuel kapatana kadar — müşteri istediği zaman okutup öder',
...
const EN: typeof TR = {
  ...
  paymentsQrModeStandingHint: 'Until you close it — customer can scan and pay anytime',
